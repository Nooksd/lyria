...
func AdminRoutes(router *gin.Engine) {
	...
	adminProtected.Use(controller.AdminAuthMiddleware())
	{
		...
		adminProtected.POST("/import/jobs/:jobId/retry", controller.RetryImportJob())
		adminProtected.POST("/import/jobs/:jobId/force-start", controller.ForceStartImportJob())
		...
		// Fingerprint generation (temporarily disabled)
